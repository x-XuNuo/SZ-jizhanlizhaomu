	...
	<view>
		...
		<view class="tc text-center padding10" v-if="propsData.src">
			<view class="audio-border x-bc">
				...
				<view class="f14 color999 padding-right10" style="width: 80upx;">{{ voiceTime }}</view>
			</view>
		</view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		createInnerAudio() {
			...
			this.innerAudioContext.autoplay = this.propsData.autoplay ? true : false;
			this.innerAudioContext.loop = this.propsData.loop ? true : false;
