<template>
	<view class="uni-navbar">
		<view
			:class="{ 'uni-navbar--fixed': propsData.fixed ? true : false, 'uni-navbar--shadow': propsData.shadow ? true : false, 'uni-navbar--border': border }"
			:style="{ 'background-color': propsData.backgroundColor }"
			class="uni-navbar__content"
		>
			<u-status-bar v-if="propsData.statusBar" />
			<view :style="{ color: propsData.color, backgroundColor: propsData.backgroundColor }" class="uni-navbar__header uni-navbar__content_view">
				<view @tap="onClickLeft" class="uni-navbar__header-btns uni-navbar__header-btns-left uni-navbar__content_view">
					<view class="uni-navbar__content_view" v-if="propsData.leftIcon"><u-icons :color="propsData.color" :type="propsData.leftIcon" :size="propsData.size" /></view>
				...
				<view :class="propsData.title ? 'uni-navbar__header-btns-right' : ''" @tap="onClickRight" class="uni-navbar__header-btns uni-navbar__content_view">
					<view class="uni-navbar__content_view" v-if="propsData.rightIcon"><u-icons :color="propsData.color" :type="propsData.rightIcon" :size="propsData.size" /></view>
					<!-- 优先显示图标 -->
