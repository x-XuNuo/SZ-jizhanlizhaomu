<template>
	<view>
		...
		<view class="example-body" v-if="this.propsData.mode == 'basic'">
			<view class="example-box">
				<u-card
					...
					:isFull="this.propsData.isFull ? true : false"
					:isShadow="this.propsData.isShadow ? true : false"
		...
		<view class="example-body" v-if="this.propsData.mode == 'style'">
			<u-card
				:is-shadow="this.propsData.isShadow ? true : false"
				:title="this.propsData.titleText"
			...
			>
				<view>
					<view class="f14 pb10 border-line one-t">
						<u-icons v-if="this.propsData.leftIcon" class="mr5" :color="this.propsData.leftIconColor" :type="this.propsData.leftIcon" />
					...
					<view class="content-box" v-if="this.propsData.cardContentList">
						<view v-for="(item, index) in this.propsData.cardContentList" :key="index">
							<view class="f14 mb10">
								...
								<u-icons v-if="item.icon" class="mr5" :color="item.iconColor" :type="item.icon" @click="iconModalClick(index)" />
							</view>
