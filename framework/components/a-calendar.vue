	...
	<view class="calendar-content">
		...
		<view v-if="this.propsData.mode == 'default'">
			<u-calendar
				...
				:lunar="this.propsData.lunar ? true : false"
				:startDate="this.propsData.startDate"
				:endDate="this.propsData.endDate"
				:range="this.propsData.range ? true : false"
				:insert="true"
				:clearDate="this.propsData.clearDate ? true : false"
				:selected="this.propsData.selectedList"
				:showMonth="this.propsData.showMonth ? true : false"
				@change="change"
				@confirm="confirm"
		...
		<view v-if="this.propsData.mode == 'dialog'">
			<view class="x-bc padding15 border-line" @click="openCalendar()">
				<view class="f14">{{ this.propsData.titleText }}</view><u-icons :type="this.propsData.rightIcon"/>
			</view>
			<u-calendar
				ref="calendar"
				:mode="this.propsData.mode"
